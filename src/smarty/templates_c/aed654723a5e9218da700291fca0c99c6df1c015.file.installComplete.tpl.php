<?php /* Smarty version Smarty-3.1.16, created on 2014-02-12 01:00:28
         compiled from "/Users/janbrejcha/Web/www/restcms/src/smarty/templates/installComplete.tpl" */ ?>
<?php /*%%SmartyHeaderCode:121040814352f9e7abe376f9-29101644%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'aed654723a5e9218da700291fca0c99c6df1c015' => 
    array (
      0 => '/Users/janbrejcha/Web/www/restcms/src/smarty/templates/installComplete.tpl',
      1 => 1392163226,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '121040814352f9e7abe376f9-29101644',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_52f9e7abe811c4_49418164',
  'variables' => 
  array (
    'project_dir' => 0,
    'timezones' => 0,
...
<?php if ($_valid && !is_callable('content_52f9e7abe811c4_49418164')) {function content_52f9e7abe811c4_49418164($_smarty_tpl) {?><!DOCTYPE html>
	<head>
		<meta charset="utf-8">
    ...
    <div class="container">
		...
		<ul class="nav nav-tabs" id="stepTabs">
			<li class="disabled"><a href="#step1"><script type="text/javascript">document.write(_("Step"))</script> 1</a></li>
			...
			<li class="active disabled"><a href="#done"><script type="text/javascript">document.write(_("Done"))</script></a></li>
		</ul>
		...
		<div class="tab-content">
			<div class="tab-pane" id="step1">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="PROJECTDIR" name="PROJECTDIR" value="<?php echo $_smarty_tpl->tpl_vars['project_dir']->value;?>
" placeholder="Enter Database Login" />
					<p class="help-block">
 ...
 $_smarty_tpl->tpl_vars['timezoneName'] = new Smarty_Variable;
...
$_smarty_tpl->tpl_vars['timezone']->_loop = true;
 $_smarty_tpl->tpl_vars['timezoneName']->value = $_smarty_tpl->tpl_vars['timezone']->key;
?>
						<option value="<?php echo $_smarty_tpl->tpl_vars['timezoneName']->value;?>
"><?php echo $_smarty_tpl->tpl_vars['timezone']->value;?>
			...
			<div class="tab-pane" id="recap">		
				...
				<button type="submit" class="btn btn-success btn-block btn-lg">Install</button>
			</form>
			</div>
			<div class="tab-pane active" id="done">		
				...
				<p>
					Congratulations! Your RestCMS has been installed on your server. Lets start <a href="<?php echo $_smarty_tpl->tpl_vars['web_address']->value;?>
">use it</a>!
				</p>
				<p>
					In case the installation is not working and you want to run reinstall, please delete the <code>src/cz/brejchajan/restcms/config/config.php</code> file and relaunch this 
					installation again.
				</p>
				<div class="page-header">
					<h2><script type="text/javascript">document.write(_("Sign in to become admin"))</script></h2>
				</div>
				<p>
					If this is the first installation of RestCMS system into the database, please
					log in for the first time with a google account that will be used as administrator
					for this website. Once you successfully logged in, you should see, that administrator
					rights were granted to this account. You may or may not log out after successful login,
					it's up to you.
				</p>
				<div id="gConnect">
					<button class="g-signin"
						...
						data-clientId="<?php echo $_smarty_tpl->tpl_vars['CLIENT_ID']->value;?>
"
				...
				<div id="gDisconnect">
					<div>Logged <span id="userEmail"></span>, In role <span id="userRole"></span>.</div>
					<button class="btn btn-primary">Log out</button>
				</div>
				</p>
				<div class="page-header">
					<h2><script type="text/javascript">document.write(_("Google Plus Sign In Button"))</script></h2>
				</div>
				<p>
					To start using Google Plus Sign In, please add following two buttons to your custom
					template (or change the button in the default template (index.html) in root 
					of the project). Note that RestCMS JS Library handles the login and logout automatically, with exactly this code.
					You can change it, but please the sign in button should be in element with id <code>gConnect</code> and the log out
					button should be in element with id <code>gDisconnect</code>.
				</p>
				<pre>
&lt;div id=&quot;gConnect&quot;&gt;
	&lt;button class=&quot;g-signin&quot;
...
&lt;/div&gt;
		...
		<script type="text/javascript">
			...
			$('body').load(function(e){
				$('#PROJECTDIR').val('<?php echo $_smarty_tpl->tpl_vars['project_dir']->value;?>
');
			});
		</script>
    </div> <!-- /container -->
